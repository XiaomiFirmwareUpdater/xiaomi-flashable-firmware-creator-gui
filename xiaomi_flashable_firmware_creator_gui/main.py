...
from xiaomi_flashable_firmware_creator_gui.components.message_box import (
    MessageBox,
    OutputMessageBox,
)
...
logging.basicConfig(
    filename=f'{current_dir}/data/last_run.log',
    filemode='w',
...
class MainWindowUi(QMainWindow):
    ...
    def menu_bar(self):
        ...
        self.menu_language.addActions(
            [
                self.action_language_sq,
                self.action_language_ar,
                self.action_language_ca,
                self.action_language_zh_CN,
                self.action_language_hr,
                self.action_language_cs,
                self.action_language_nl,
                self.action_language_en,
                self.action_language_fr,
                self.action_language_de,
                self.action_language_el,
                self.action_language_hi,
                self.action_language_id,
                self.action_language_it,
                self.action_language_ms,
                self.action_language_fa,
                self.action_language_pl,
                self.action_language_pt_BR,
                self.action_language_ro,
                self.action_language_ru,
                self.action_language_sl,
                self.action_language_es_ES,
                self.action_language_tr,
                self.action_language_uk,
                self.action_language_vi,
            ]
        )
        self.menu_help.addActions(
            [self.action_report_bug, self.action_donate, self.action_about, self.action_website]
        )
        ...
        self.action_language_sq.triggered.connect(lambda: self.change_language('sq'))
        self.action_language_ar.triggered.connect(lambda: self.change_language('ar'))
        self.action_language_ca.triggered.connect(lambda: self.change_language('ca'))
        self.action_language_zh_CN.triggered.connect(lambda: self.change_language('zh-CN'))
        self.action_language_hr.triggered.connect(lambda: self.change_language('hr'))
        self.action_language_cs.triggered.connect(lambda: self.change_language('cs'))
        self.action_language_nl.triggered.connect(lambda: self.change_language('nl'))
        self.action_language_en.triggered.connect(lambda: self.change_language('en_US'))
        self.action_language_fr.triggered.connect(lambda: self.change_language('fr'))
        self.action_language_de.triggered.connect(lambda: self.change_language('de'))
        self.action_language_el.triggered.connect(lambda: self.change_language('el'))
        self.action_language_hi.triggered.connect(lambda: self.change_language('hi'))
        self.action_language_id.triggered.connect(lambda: self.change_language('id'))
        self.action_language_it.triggered.connect(lambda: self.change_language('it'))
        self.action_language_ms.triggered.connect(lambda: self.change_language('ms'))
        self.action_language_fa.triggered.connect(lambda: self.change_language('fa'))
        self.action_language_pl.triggered.connect(lambda: self.change_language('pl'))
        self.action_language_pt_BR.triggered.connect(lambda: self.change_language('pt-BR'))
        self.action_language_ro.triggered.connect(lambda: self.change_language('ro'))
        self.action_language_ru.triggered.connect(lambda: self.change_language('ru'))
        self.action_language_sl.triggered.connect(lambda: self.change_language('sl'))
        self.action_language_es_ES.triggered.connect(lambda: self.change_language('es-ES'))
        self.action_language_tr.triggered.connect(lambda: self.change_language('tr'))
        self.action_language_uk.triggered.connect(lambda: self.change_language('uk'))
        self.action_language_vi.triggered.connect(lambda: self.change_language('vi'))
    ...
    def re_translate_ui(self):
        ...
        Items strings
        """
        self.setWindowTitle(self._translate('Title', 'Xiaomi Flashable Firmware Creator'))
        ...
        self.action_report_bug.setStatusTip(
            self._translate('Menu bar', 'Submit an issue ' 'in case anything is wrong')
        )
    ...
    def select_file(self):
        ...
        filepath = dialog.getOpenFileName(
            ...
            '',
            self._translate('Select Files Dialog', 'MIUI zip files') + ' (*.zip)',
        )[0]
        if not filepath:
    ...
    def enter_url(self):
        ...
        """
        dialog = InputDialog(
            self._translate('Enter URL Dialog', 'Remote Zip URL'),
    ...
    def create_zip(self):
        ...
        firmware_creator = FlashableFirmwareCreator(str(self.filepath), process, out_dir)
        self.progress_bar.setValue(1)
        logging.info(f'Starting extract job')
        self.progress_bar.setValue(5)
        self.status_box.setText(self._translate('Status Box', f'Unzipping MIUI ROM...'))
